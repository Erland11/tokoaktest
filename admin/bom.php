...
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid gray"><b>Master Barang</b></h2>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">RINCIAN BARANG <?= strtoupper($tam['nama']); ?></h4>
				</div>
