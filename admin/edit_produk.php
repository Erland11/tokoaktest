					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="material[]" class="form-control" placeholder="Masukkan Kode Barang" value="<?= $row3['kode_bk']; ?>" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control"placeholder="Contoh : 250 " name="keb[]" value="<?= $row3['kebutuhan']; ?>" required>
